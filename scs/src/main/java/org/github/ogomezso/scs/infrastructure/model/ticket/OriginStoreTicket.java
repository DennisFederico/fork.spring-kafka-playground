...
public class OriginStoreTicket extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2895214475121687288L;
   ...
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder newBuilder() {
    return new org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder();
  }
   ...
   * @return A new OriginStoreTicket RecordBuilder
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder newBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder other) {
    if (other == null) {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder();
    } else {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder(other);
    }
  }
   ...
   * @return A new OriginStoreTicket RecordBuilder
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder newBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket other) {
    if (other == null) {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder();
    } else {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OriginStoreTicket>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.ticketDate)) {
        this.ticketDate = data().deepCopy(fields()[0].schema(), other.ticketDate);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder setTicketDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder clearTicketDate() {
      ticketDate = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder setStorePublicId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder clearStorePublicId() {
      storePublicId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder setTicketNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder clearTicketNumber() {
      ticketNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder setPosId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.OriginStoreTicket.Builder clearPosId() {
      posId = null;
