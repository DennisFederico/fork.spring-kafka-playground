...
public class PaymentMethodbankTransfer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1189722187052920127L;
  ...
  private org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment transferPayment;
   ...
   */
  public PaymentMethodbankTransfer(org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment transferPayment, java.lang.CharSequence authorizedNif) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: transferPayment = (org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment)value$; break;
   ...
   */
  public org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment getTransferPayment() {
   ...
   */
  public void setTransferPayment(org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment value) {
   ...
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder newBuilder() {
    return new org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder();
  }
   ...
   * @return A new PaymentMethodbankTransfer RecordBuilder
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder newBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder other) {
    if (other == null) {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder();
    } else {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder(other);
    }
  }
   ...
   * @return A new PaymentMethodbankTransfer RecordBuilder
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder newBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer other) {
    if (other == null) {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder();
    } else {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentMethodbankTransfer>
    ...
    private org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment transferPayment;
    private org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment.Builder transferPaymentBuilder;
    private java.lang.CharSequence authorizedNif;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder other) {
      super(other);
      ...
      if (other.hasTransferPaymentBuilder()) {
        this.transferPaymentBuilder = org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment.newBuilder(other.getTransferPaymentBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.transferPayment)) {
        this.transferPayment = data().deepCopy(fields()[0].schema(), other.transferPayment);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder setTransferPayment(org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment value) {
     ...
     * @return This builder.
     */
    public org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment.Builder getTransferPaymentBuilder() {
      if (transferPaymentBuilder == null) {
        if (hasTransferPayment()) {
          setTransferPaymentBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment.newBuilder(transferPayment));
        } else {
          setTransferPaymentBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment.newBuilder());
        }
      }
    ...
    public org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder setTransferPaymentBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder clearTransferPayment() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder setAuthorizedNif(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.PaymentMethodbankTransfer.Builder clearAuthorizedNif() {
      authorizedNif = null;
    ...
    public PaymentMethodbankTransfer build() {
      try {
        ...
        if (transferPaymentBuilder != null) {
          ...
          record.transferPayment = fieldSetFlags()[0] ? this.transferPayment : (org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment) defaultValue(fields()[0]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.transferPayment == null) {
        this.transferPayment = new org.github.ogomezso.scs.infrastructure.model.ticket.TransferPayment();
      }
