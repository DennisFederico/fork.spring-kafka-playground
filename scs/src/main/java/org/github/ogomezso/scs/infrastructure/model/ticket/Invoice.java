...
public class Invoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7083231808868745241L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Invoice\",\"namespace\":\"org.github.ogomezso.scs.infrastructure.model.ticket\",\"fields\":[{\"name\":\"invoiceHandOverTypeId\",\"type\":\"string\"},{\"name\":\"vatNumber\",\"type\":\"string\"},{\"name\":\"branchOfficeId\",\"type\":\"string\"}]}");
   ...
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder newBuilder() {
    return new org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder();
  }
   ...
   * @return A new Invoice RecordBuilder
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder newBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder other) {
    if (other == null) {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder();
    } else {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder(other);
    }
  }
   ...
   * @return A new Invoice RecordBuilder
   */
  public static org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder newBuilder(org.github.ogomezso.scs.infrastructure.model.ticket.Invoice other) {
    if (other == null) {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder();
    } else {
      return new org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Invoice>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.github.ogomezso.scs.infrastructure.model.ticket.Invoice other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.invoiceHandOverTypeId)) {
        this.invoiceHandOverTypeId = data().deepCopy(fields()[0].schema(), other.invoiceHandOverTypeId);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder setInvoiceHandOverTypeId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder clearInvoiceHandOverTypeId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder setVatNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder clearVatNumber() {
      vatNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder setBranchOfficeId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.scs.infrastructure.model.ticket.Invoice.Builder clearBranchOfficeId() {
      branchOfficeId = null;
