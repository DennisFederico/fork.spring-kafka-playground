...
public class PaymentMethodCashRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8638248281696816142L;
  ...
  private org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment cashPayment;
   ...
   */
  public PaymentMethodCashRecord(org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment cashPayment, java.lang.Boolean isPendingCash, java.lang.Boolean isCancelled) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: cashPayment = (org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment)value$; break;
   ...
   */
  public org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment getCashPayment() {
    return cashPayment;
  }
   ...
   */
  public void setCashPayment(org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment value) {
   ...
   */
  public static org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder newBuilder() {
    return new org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder();
  }
   ...
   * @return A new PaymentMethodCashRecord RecordBuilder
   */
  public static org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder newBuilder(org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder other) {
    if (other == null) {
      return new org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder();
    } else {
      return new org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder(other);
    }
  }
   ...
   * @return A new PaymentMethodCashRecord RecordBuilder
   */
  public static org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder newBuilder(org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord other) {
    if (other == null) {
      return new org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder();
    } else {
      return new org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentMethodCashRecord>
    ...
    private org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment cashPayment;
    private org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment.Builder cashPaymentBuilder;
    private boolean isPendingCash;
    private boolean isCancelled;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder other) {
      super(other);
      ...
      if (other.hasCashPaymentBuilder()) {
        this.cashPaymentBuilder = org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment.newBuilder(other.getCashPaymentBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.cashPayment)) {
        this.cashPayment = data().deepCopy(fields()[0].schema(), other.cashPayment);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder setCashPayment(org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment value) {
     ...
     * @return This builder.
     */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment.Builder getCashPaymentBuilder() {
      if (cashPaymentBuilder == null) {
        if (hasCashPayment()) {
          setCashPaymentBuilder(org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment.newBuilder(cashPayment));
        } else {
          setCashPaymentBuilder(org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment.newBuilder());
        }
      }
    ...
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder setCashPaymentBuilder(org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment.Builder value) {
      clearCashPayment();
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder clearCashPayment() {
      cashPayment = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder setIsPendingCash(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder clearIsPendingCash() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder setIsCancelled(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord.Builder clearIsCancelled() {
    ...
    public PaymentMethodCashRecord build() {
      try {
        ...
        if (cashPaymentBuilder != null) {
          ...
          record.cashPayment = fieldSetFlags()[0] ? this.cashPayment : (org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment) defaultValue(fields()[0]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.cashPayment == null) {
        this.cashPayment = new org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment();
      }
