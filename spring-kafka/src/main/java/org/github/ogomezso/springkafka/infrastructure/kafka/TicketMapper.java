...
import org.github.ogomezso.springkafka.infrastructure.model.ticket.CardPayment;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.CashPayment;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.CouponPayment;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.Header;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.Invoice;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.LinesRecord;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.OriginStoreTicket;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.ParkedLinesRecord;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCashRecord;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCouponRecord;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodCreditCardRecord;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.PaymentMethodbankTransfer;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.ReturnStoreTicket;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.ScaleRecord;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.TicketLineTax;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.TicketMessage;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.TotalTaxRecord;
import org.github.ogomezso.springkafka.infrastructure.model.ticket.TransferPayment;
import org.springframework.stereotype.Component;

@Component
class TicketMapper {

  TicketMessage toAvro(Ticket ticket) {
  ...
  private Invoice mapInvoice(org.github.ogomezso.springkafka.domain.model.Invoice invoice) {
