...
public class Identity extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2591267137291615621L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Identity\",\"namespace\":\"org.github.ogomezso.springkafka.infrastructure.model.ticket\",\"fields\":[{\"name\":\"ticketDate\",\"type\":\"string\"},{\"name\":\"storePublicId\",\"type\":\"string\"},{\"name\":\"ticketNumber\",\"type\":\"string\"},{\"name\":\"posId\",\"type\":\"string\"}]}");
   ...
   */
  public static org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder newBuilder() {
    return new org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder();
  }
   ...
   * @return A new Identity RecordBuilder
   */
  public static org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder newBuilder(org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder other) {
    if (other == null) {
      return new org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder();
    } else {
      return new org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder(other);
    }
  }
   ...
   * @return A new Identity RecordBuilder
   */
  public static org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder newBuilder(org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity other) {
    if (other == null) {
      return new org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder();
    } else {
      return new org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Identity>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.ticketDate)) {
        this.ticketDate = data().deepCopy(fields()[0].schema(), other.ticketDate);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder setTicketDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder clearTicketDate() {
      ticketDate = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder setStorePublicId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder clearStorePublicId() {
      storePublicId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder setTicketNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder clearTicketNumber() {
      ticketNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder setPosId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.github.ogomezso.springkafka.infrastructure.model.ticket.Identity.Builder clearPosId() {
      posId = null;
